...
public class HighEndIconRenderer {
    ...
    public static void RenderQuantumDice(string dst) {
        ...
        using (Bitmap bmp = new Bitmap(S, S, PixelFormat.Format32bppArgb)) {
            using (Graphics g = Graphics.FromImage(bmp)) {
                ...
                DrawQuantumPip(g, new PointF(cx, cy - 140), 22f);
                DrawQuantumPip(g, new PointF(cx - 95, cy - 85), 20f);
                DrawQuantumPip(g, new PointF(cx + 95, cy - 195), 20f);

                // 左侧面点数 (5 点，菱形排列)
                float lcx = (topCenter.X + topW.X + botW.X + botCenter.X) / 4f;
                float lcy = (topCenter.Y + topW.Y + botW.Y + botCenter.Y) / 4f;
                DrawLeftPip(g, new PointF(lcx, lcy), 20f);
                DrawLeftPip(g, new PointF(lcx - 65, lcy - 45), 18f);
                DrawLeftPip(g, new PointF(lcx + 65, lcy + 45), 18f);
                DrawLeftPip(g, new PointF(lcx - 65, lcy + 45), 18f);
                DrawLeftPip(g, new PointF(lcx + 65, lcy - 45), 18f);
                ...
                DrawLeftPip(g, new PointF(rcx - 60, rcy - 40), 18f);
                DrawLeftPip(g, new PointF(rcx + 60, rcy + 40), 18f);
                DrawLeftPip(g, new PointF(rcx - 60, rcy + 40), 18f);
                DrawLeftPip(g, new PointF(rcx + 60, rcy - 40), 18f);
    ...
    private static void DrawQuantumPip(Graphics g, PointF center, float radius) {
    ...
    private static void DrawLeftPip(Graphics g, PointF center, float radius) {
        using (GraphicsPath gp = new GraphicsPath()) {
