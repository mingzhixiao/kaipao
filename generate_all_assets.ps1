# ==============================================================================
# 全局美术重制生成器：生成所有精致 UI 图标与 14 大符文重制资产
# 遵循 create-game-assets 与 game-ui-ux 技能标准：高清、深空科幻、层次丰富、光影通透
# ==============================================================================
        ...
        using (Bitmap bmp = new Bitmap(S, S, PixelFormat.Format32bppArgb)) {
            using (Graphics g = Graphics.FromImage(bmp)) {
                ...
                using (Pen helixPen1 = new Pen(Color.FromArgb(255, 244, 63, 94), 14f)) {
                    ...
                    g.DrawBezier(new Point(-60, -180), new Point(60, -90), new Point(-60, 90), new Point(60, 180));
                }
...
# 目标输出路径
$runeDir = "D:\test\kaipao\assets\runes"
$iconDir = "D:\test\kaipao\assets\icons"
...
Write-Host ">>> 正在生成 14 大符文重制资产..." -ForegroundColor Cyan
...
Write-Host ">>> 正在生成全部 UI 矢量与拟物图标 (替换 Emoji)..." -ForegroundColor Yellow
...
Write-Host ">>> 资产全部生成完成！" -ForegroundColor Green
