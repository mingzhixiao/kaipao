...
export const GAME_CONFIG = {
  ...
  // 双模式配置 (普通 vs 精英)
  modes: {
    normal: { id: 'normal', name: '普通模式', tag: '标准探索', color: '#38bdf8', hpMult: 1.0, shieldMult: 1.0, physicalResistanceBonus: 0, atkMult: 1.0, countMult: 1.0, scrapMult: 1.0, shardMult: 1.0, gemChance: 0.15, desc: '标准的尸潮进攻强度，适合开荒推进与稳步收集素材。' },
    elite: { id: 'elite', name: '精英模式', tag: '极度凶险', color: '#f43f5e', hpMult: 1.85, shieldMult: 1.6, physicalResistanceBonus: 0.08, atkMult: 1.85, countMult: 1.35, scrapMult: 2.2, shardMult: 2.0, gemChance: 0.70, desc: '极度高危作战！感染者不仅血量、物抗与装甲护盾大幅强化，破坏力亦翻倍，所有战利品与芯片极高爆率！' }
  },
  ...
  enemies: {
    runner: { radius: 20, baseHp: 75, speedMin: 44, speedMax: 62, attackPower: 22, attackCooldown: 1.2, expVal: 6, color: '#10b981', name: '普通感染者', shieldMod: 0.6 },
    charger: { radius: 18, baseHp: 68, speedMin: 84, speedMax: 112, attackPower: 24, attackCooldown: 0.9, expVal: 9, color: '#f59e0b', name: '疾行冲锋者', shieldMod: 0.8 },
    behemoth: { radius: 36, baseHp: 580, speedMin: 36, speedMax: 47, attackPower: 70, attackCooldown: 1.5, expVal: 24, color: '#ef4444', name: '重装巨尸', shieldMod: 1.35 },
    boss_overlord: { radius: 48, baseHp: 2400, speed: 36, attackPower: 120, attackCooldown: 1.4, expVal: 70, color: '#ff2a5f', stompInterval: 4.0, name: '哨站行刑官', shieldMod: 1.6 }
  },
